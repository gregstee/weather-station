...
ADAFRUIT_IO_KEY = 'aio_MjjF87EGSx5Ky2OBCF5wq1noEzaU'

# Set to your Adafruit IO username.
# (go to https://accounts.adafruit.com to find your username)
ADAFRUIT_IO_USERNAME = 'JodyD78'
...
while True:
    ...
    ##  aio.send(altitude_feed.key, int(alt_data))
        # avoid timeout from adafruit
    iotime.sleep(LOOP_DELAY * 900)
